...
namespace NetCore.PeddEval.Web.WebSite
{
    public class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            var jsCore = new Bundle("~/bundles/core");
            jsCore.Include("~/assets/js/core/core.js");
            jsCore.Builder = nullBuilder;
            jsCore.Transforms.Add(scriptTransformer);
            jsCore.Orderer = nullOrderer;
            bundles.Add(jsCore);
        }
