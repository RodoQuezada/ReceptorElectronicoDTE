...
namespace NetCore.PeddEval.DataAccess
{
    public class Evaluacion : CommonDataAccess
    {
        ...
        private const string spSelectReglas = "sp_eval_reglas_select";
      ...
      public DataTable SelectAll(int IdUsuario, int IdEmpresa, int IdSucursal, int IdArea, int IdProveedor )
        {
            DataTable dt = null;
            try
            {
                using (DbConnection conn = db.CreateConnection())
                {
                    try
                    {
                        ...
                        try
                        {
                            cmd = db.GetStoredProcCommand(spSelectReglas, IdArea,IdEmpresa,IdSucursal,IdUsuario,IdProveedor );
